...
```bash
node ${CLAUDE_PLUGIN_ROOT}/skills/study-brain-init/scripts/init.mjs
```
...
Read `skills/study-brain-site/references/deploy.md` before turning deploy on.
